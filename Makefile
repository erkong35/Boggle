#############################################################################
# Makefile for building: P4
# Generated by qmake (3.0) (Qt 5.0.1) on: Sat Dec 6 16:05:30 2014
# Project:  P4.pro
# Template: app
# Command: /software/common/qt-5.0.1/bin/qmake -o Makefile P4.pro
#############################################################################
...
Makefile: P4.pro /software/common/qt-5.0.1/mkspecs/linux-g++/qmake.conf /software/common/qt-5.0.1/mkspecs/features/spec_pre.prf \
		/software/common/qt-5.0.1/mkspecs/common/shell-unix.conf \
		/software/common/qt-5.0.1/mkspecs/common/unix.conf \
		/software/common/qt-5.0.1/mkspecs/common/linux.conf \
		/software/common/qt-5.0.1/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/P41.0.0 || $(MKDIR) .tmp/P41.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/P41.0.0/ && $(COPY_FILE) --parents baseboggleplayer.h boggleboard.h boggleplayer.h boggleutil.h mainwindow.h ui_mainwindow.hpp .tmp/P41.0.0/ && $(COPY_FILE) --parents boggleboard.cpp boggleplayer.cpp boggleutil.cpp main.cpp mainwindow.cpp .tmp/P41.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/P41.0.0/ && (cd `dirname .tmp/P41.0.0` && $(TAR) P41.0.0.tar P41.0.0 && $(COMPRESS) P41.0.0.tar) && $(MOVE) `dirname .tmp/P41.0.0`/P41.0.0.tar.gz . && $(DEL_FILE) -r .tmp/P41.0.0
